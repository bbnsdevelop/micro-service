...
import br.com.token.security.config.SecurityTokenConfig;
import br.com.token.security.token.creator.TokenCreator;
...
public class SecurityCredentialsConfig extends SecurityTokenConfig {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http
			.addFilter(
					new JwtUsernameAndaPasswordAuthenticationFilter(authenticationManager(), 
